...
/* 	var  text = "数据加载中...";
	 ...
	 */
	$.mask_fullscreen = function(timeout,text){
		...
		var mask = '<div class="mask" ele="full_screen"><div>'+title+'</div></div>';
		$("body").append(mask);
	 ...
	 */
	$.mask_element = function(ele_id, timeout,text){
		...
		//添加遮罩元素
		var mask = '<div class="mask" ele='+ele_id+' style="width: '+$(ele_id).width()+'px !important; height: '+$(ele_id).height()+'px !important; left: '+$(ele_id).offset().left+'px !important; top: '+$(ele_id).offset().top+'px !important;"><div>'+title+'</div></div>';
		$("body").append(mask);
