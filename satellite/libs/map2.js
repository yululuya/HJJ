...
function toggleEarthMap() {
    if (mapMode == 2) {
        ...
        }, 3000).easing(TWEEN.Easing.Quadratic.Out).onUpdate(
            function() {

                mixObj.value = this.value;
                mapPlane.rotation.y = this.earthY;
                targetEarthRotationX = 0;
                mapPlane.rotation.x = this.earthX;
...
/**
 * 丝绸之路单独显示，   国内十大事件 和国外十大事件 可以一同显示
 * @param typeId
 */
    ...
    if (mode == 3) {
        ...
        switch (type) {
            case "ForeignSyncSatellite":
                console.log("ForeignSyncSatellite")
                scaleTo(1);
                earthRotate = true;
                targetEarthRotationY = 0.4;
            ...
            case "NativeSyncSatellite":
                ...
                console.log("NativeSyncSatellite")
                scaleTo(1);
                earthRotate = true;
            ...
            case "ForeignPolarSatellite":
                ...
                console.log("ForeignPolarSatellite")
                scaleTo(1);
                earthRotate = true;
                targetEarthRotationY = 0.4;
            ...
            case "NativePolarSatellite":
                ...
                console.log("NativePolarSatellite")
